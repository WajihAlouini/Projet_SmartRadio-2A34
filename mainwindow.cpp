...
void MainWindow::on_bp_supprime_clicked()
{
...
void MainWindow::on_bp_modifier_clicked()
{
    QString nom=ui->le_nom->text();
    QString duree=ui->le_duree->text();
    QString heure=ui->le_heure->text();
...
void MainWindow::on_bp_tri_clicked()
{
    ui->tabspons->setModel(S.afficherTri());
}
void MainWindow::on_bp_rech_clicked()
{
    sponsor S;
...
void MainWindow::on_bp_pdf_clicked()
{
    QSqlDatabase db;
                   QTableView tabspons;
...
void MainWindow::on_bp_aller_clicked()
{
...
void MainWindow::on_bp_play_clicked()
{
    reloj.start(1000);
}

void MainWindow::on_bp_pause_clicked()
{
    if (pause==false){
        reloj.stop();
        pause=true;
