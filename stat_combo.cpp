...
q2.prepare("SELECT * FROM  WHERE COMBO='choix1'");
q2.exec();

q3.prepare("SELECT * FROM sponsor WHERE COMBO='choix2'");
q3.exec();

q4.prepare("SELECT * FROM sponsor WHERE COMBO='choix3' ");
q4.exec();
...
//pie chart
    ...
    q2.prepare("SELECT * FROM sponsor WHERE COMBO='choix1'");
    q2.exec();
